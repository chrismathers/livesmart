#LiveSmart - based on the seed for AngularJS apps

Clone the `livesmart` repository using git:

```
git clone https://github.com/chrismathers/livesmart.git
```
...
```
app/                    --> all of the source files for 
  controllers/
  data/
  directives/
  services/
  app.js
  index.html
karma.conf.js         --> TODO: config file for running unit tests with Karma
e2e-tests/            --> TODO: end-to-end tests
